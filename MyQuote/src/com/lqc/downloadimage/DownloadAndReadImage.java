					...
					if(!direct.exists())
					{
						if(direct.mkdir()){
							try{
								...
								Toast.makeText(mContext.getApplicationContext(), "Cannot download image, please try again", Toast.LENGTH_SHORT).show();
							}
						}  

					}
				} else {
					Toast.makeText(mContext.getApplicationContext(), "Please make sure your sdcard is mounted", Toast.LENGTH_SHORT).show();
				}
			}
		}
	}
